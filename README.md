...
> **Built something with Ralph?** See the [Showcase](SHOWCASE.md) — add a credit line to your README and you're on the page (60-second task). Also see the [Ecosystem Map](ECOSYSTEM.md) — projects using Ralph discovered through code-level search. Read the [ecosystem blog post](https://ralphworkflow.com/blog/ralph-workflow-ecosystem-2026) for a tour of 30+ projects. The [awesome-ralph](https://github.com/snwfdhmp/awesome-ralph) list (904 ⭐) is the community directory of Loop Engineering implementations, workshops, and skill packs.
