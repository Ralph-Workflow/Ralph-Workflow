...
Ralph Workflow is a free and open-source AI agent orchestrator built around a composable loop: planning → development → verification, each phase driving the next. It runs the coding agents you already use (Claude Code, Codex, OpenCode) on your own machine, and the default workflow is strong enough to start with before you customize anything.
...
This is the same test we recommend in the [Ralph Workflow comparison guide](https://ralphworkflow.com/blog/ralph-workflow-comparison-guide):
...
- **Install:** [ralphworkflow.com/install](https://ralphworkflow.com/install)
- **Docs:** [ralphworkflow.com/docs](https://ralphworkflow.com/docs/quickstart)
...
- **Blog deep-dive:** [Your First Overnight Task: A Start-Here Guide](https://ralphworkflow.com/blog/your-first-overnight-task-start-here-guide)
