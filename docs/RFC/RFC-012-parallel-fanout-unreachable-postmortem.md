...
`make verify` passes (7443 tests, within the 60 s budget).
...
7. **Adversarial review of "complete" fixes pays for itself — twice here.** The first remediation passed all 7371 existing tests plus 9 new ones and full verification, and was refuted by replaying real coordinator events through the real reducer. The second passed 7441 and was refuted on checkpoint ordering. Green CI measures the asserted surface, not the system.
