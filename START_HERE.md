...
It runs the coding agents you already use, on your own machine. The simple Ralph loop composes into larger workflows and ships with a strong default workflow for substantial, well-specified software engineering. Use the default as-is, then customize when you're ready.
