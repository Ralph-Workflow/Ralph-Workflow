...
It runs the coding agents you already use, on your own machine. The simple Ralph loop composes into a strong default workflow for substantial, well-specified software engineering. Customize when you're ready.
