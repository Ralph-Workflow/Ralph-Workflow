...
#[cfg(test)]
mod tests {
    use super::classify_file_length;
    ...
    #[test]
    fn files_below_guideline_are_allowed() {
        assert_eq!(classify_file_length(499), FileLengthDisposition::Allowed);
    }

    #[test]
    fn files_at_consider_threshold_are_not_hard_failures() {
        assert_eq!(
    ...
    #[test]
    fn files_at_must_refactor_threshold_are_hard_failures() {
        assert_eq!(
