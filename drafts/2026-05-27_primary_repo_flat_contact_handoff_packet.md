...
## Current state
- Recently contacted executable targets already inside the active review window: AI Saying, AXME Code, Beam, Bollwerk, Bollwerk / Werkstatt
- Remaining discovered targets are not runtime-sendable here: ctxt.dev / Signum, TLDL, ComputingForGeeks
