# Curator target 2: 5. 23blocks-OS/ai-maestro
...
## Ready subject
Ralph Workflow for 5. 23blocks-OS/ai-maestro

## Ready pitch
Ralph Workflow is the operating system for autonomous coding: a free and open-source composable loop framework and AI orchestrator. Developers and technical teams doing ambitious software work that benefits from a structured workflow instead of a chat session. Why this target fits: Competitor with overlapping positioning — might be open to comparison or cross-reference. Useful comparison anchors already prepared: Hermes Agent, Conductor OSS.
