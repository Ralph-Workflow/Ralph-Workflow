# Curator target 1: 7. Any running AIToolsIndex / ToolShelf submission
...
## Ready subject
Ralph Workflow for 7. Any running AIToolsIndex / ToolShelf submission

## Ready pitch
Ralph Workflow is the operating system for autonomous coding: a free and open-source composable loop framework and AI orchestrator. Developers and technical teams doing ambitious software work that benefits from a structured workflow instead of a chat session. Why this target fits: It fits the list scope cleanly.. Useful comparison anchors already prepared: Hermes Agent, Conductor OSS.
