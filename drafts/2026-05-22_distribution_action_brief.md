...
- Apollo is authenticated, but the runtime still lacks proof of a usable live import/sequence step, so do not treat packet generation alone as a live lane.
