...
If you are searching for an AI agent orchestration CLI, the real question is not whether a tool can call an agent. The real question is whether it can turn longer coding work into something you would actually inspect, test, and maybe merge.
...
A useful orchestration CLI should do more than wrap one prompt:
...
2. Use START_HERE.md for one real first run
3. Judge the morning-after handoff with the merge question: would you actually merge it?

If GitHub is where you already track projects, the mirror is here:
