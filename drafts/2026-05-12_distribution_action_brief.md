...
- 62 curator contact attempts already shipped in the last 24 hours.
- 106 live external marketing action(s) already shipped in the last 6 hours.
...
- A post-cooldown StackOverflow run is already scheduled in the current review window, so another pre-cooldown packet refresh would be fake progress.
