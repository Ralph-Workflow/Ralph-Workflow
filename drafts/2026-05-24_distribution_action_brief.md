...
- 38 curator contact attempts already shipped in the last 24 hours.
...
- 18 curator targets are already inside active reply/backlink review windows, so another same-family outreach batch would mostly create unmeasurable overlap.
