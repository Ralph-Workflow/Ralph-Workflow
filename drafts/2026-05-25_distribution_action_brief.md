...
- Primary-repo-flat repair already surfaced fresh developer-native publishers with public contact paths (ctxt.dev / Signum, NxCode, TIMEWELL), so the loop should package that Codeberg-first outreach instead of ending at measurement hold.
