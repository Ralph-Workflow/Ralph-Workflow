...
DEFAULT_COMMIT_MESSAGE_TEMPLATE = (
    ...
    "and write it in lowercase imperative mood. Generate a single-line conventional commit subject only.\n\n"
    "STRICT OUTPUT RULES:\n"
    "Do not explain the diff. Do not output bullets, markdown, sections, rationale, or file lists.\n"
    ...
    "Call the tool before emitting any final text. If you skip the tool call, the task has failed.\n\n"
    "MCP REQUIREMENT:\n"
    ...
    "3. After the MCP call succeeds, optionally echo that same single line once and nothing else.\n\n"
    "DIFF:\n"
    "{{ DIFF }}\n\n"
