...
fn detect_autogenerated_reason(source: &str) -> Option<&'static str> {
...
fn format_autogenerated_marker_message(path: &Path) -> String {
...
fn collect_autogenerated_marked_files(repo_root: &Path) -> std::io::Result<Vec<PathBuf>> {
    ...
    for path in rust_files {
        ...
        if detect_autogenerated_reason(&source).is_some() {
            let relative_path = path
                .strip_prefix(repo_root)
                .map_or_else(|_| path.clone(), Path::to_path_buf);
            marked_files.push(relative_path);
        }
    }
...
pub const NATIVE_REQUIRED_CHECKS: &[NativeCheck] = &[
    ...
    NativeCheck {
        name: "audit-no-real-git-in-tests",
        run: crate::boundary::compliance::check_no_real_git_in_tests,
    },
    NativeCheck {
...
/// Frontend install: bun install must complete before lint/test can start.
...
mod tests {
    ...
    fn test_detects_autogenerated_reason_marker_in_rust_source() {
        let marked =
            detect_autogenerated_reason("// reason = \"autogenerated\"\nfn generated() {}\n");
    ...
    fn test_verify_fast_emits_autogenerated_info_message() {
        ...
        assert!(
            reporter.events().contains(
                &"info:ralph-workflow/src/generated.rs has been marked as autogenerated"
                    .to_string()
            ),
