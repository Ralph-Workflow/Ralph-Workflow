//! Shared types for xtask: pure data structures with no side effects.
//!
//! These types are used by both the domain layer and the I/O boundary layer.
//! Placing them here avoids circular dependencies and allows domain code to
//! reference them without importing from a boundary module.
