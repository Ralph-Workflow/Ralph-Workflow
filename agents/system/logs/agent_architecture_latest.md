...
- Checked: 2026-05-28T03:58:02.590291+02:00
...
- Live running jobs now: agent-architecture-watchdog, marketing-momentum-watchdog, marketing-workflow-audit-precheck, reddit-pipeline-watchdog, system-health-monitor
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 25 enabled/total-visible jobs, 0 disabled jobs, 5 running jobs, and 0 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 25 enabled jobs, 0 disabled jobs, 5 running jobs, and 0 live last-error jobs.
