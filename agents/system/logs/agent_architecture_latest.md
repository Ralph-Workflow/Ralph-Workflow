...
- Checked: 2026-05-27T02:01:06.693375+02:00
...
- Live running jobs now: agent-architecture-watchdog, marketing-momentum-watchdog, ralph-workflow-docs-verifier-supervisor, reddit-pipeline-watchdog, system-health-monitor
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 22 enabled/total-visible jobs, 0 disabled jobs, 5 running jobs, and 0 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 22 enabled jobs, 0 disabled jobs, 5 running jobs, and 0 live last-error jobs.
