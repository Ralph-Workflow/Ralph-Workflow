...
- Checked: 2026-05-26T23:03:56.894387+02:00
...
- Verifier status: pending_post_audit_refresh
- Verifier verdict: pending_refresh

## Live topology

- Live Gateway jobs: 23 total / 23 enabled / 0 disabled
- Live running jobs now: agent-architecture-watchdog, marketing-measurement-hold-release, marketing-momentum-watchdog, ralph-workflow-docs-verifier-supervisor, reddit-pipeline-watchdog, system-health-monitor
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 23 enabled/total-visible jobs, 0 disabled jobs, 6 running jobs, and 0 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 23 enabled jobs, 0 disabled jobs, 6 running jobs, and 0 live last-error jobs.
...
- Performed: pending post-audit refresh
- Verdict: pending_refresh
- Summary: Post-audit independent verification must be rerun; see verifier artifact for the fresh result.
- Previous artifact verdict: qualified_pass
- Previous artifact checked at: 2026-05-26T23:02:58.924530+02:00
