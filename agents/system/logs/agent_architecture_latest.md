...
- Checked: 2026-06-04T13:43:49.501711+02:00
...
- Live running jobs now: agent-architecture-watchdog, codeberg-github-mirror-sync, marketing-workflow-audit, ralph-docs-supervisor-precheck, ralph-site-owner-loop, repo-adoption-tracker, system-health-monitor
- Live last-error residue: backlink-tracker, blocked-channel-recovery, internal-linking-watchdog
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 22 enabled/total-visible jobs, 0 disabled jobs, 7 running jobs, and 3 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 22 enabled jobs, 0 disabled jobs, 7 running jobs, and 3 live last-error jobs.
