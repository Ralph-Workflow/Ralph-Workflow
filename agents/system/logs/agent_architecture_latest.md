...
- Checked: 2026-06-04T20:44:38.984712+02:00
...
- Live running jobs now: agent-architecture-watchdog, ralph-docs-supervisor-precheck, repo-adoption-tracker
- Live last-error residue: Push research findings to git repo, blocked-channel-recovery, competitor-analysis, internal-linking-watchdog, marketing-active-loop, marketing-churn-watchdog
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 21 enabled/total-visible jobs, 0 disabled jobs, 3 running jobs, and 6 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 21 enabled jobs, 0 disabled jobs, 3 running jobs, and 6 live last-error jobs.
