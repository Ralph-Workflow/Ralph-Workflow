...
- Checked: 2026-06-06T08:41:08.544483+02:00
...
- Live running jobs now: agent-architecture-watchdog, codeberg-github-mirror-sync, marketing-research-daily, marketing-workflow-audit, ralph-docs-supervisor-precheck, system-health-monitor
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 19 enabled/total-visible jobs, 0 disabled jobs, 6 running jobs, and 0 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 19 enabled jobs, 0 disabled jobs, 6 running jobs, and 0 live last-error jobs.
...
- Previous artifact checked at: 2026-06-06T08:40:23.322125+02:00
