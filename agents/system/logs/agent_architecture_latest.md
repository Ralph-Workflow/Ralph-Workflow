...
- Checked: 2026-05-29T15:45:57.869844+02:00
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 23 enabled/total-visible jobs, 0 disabled jobs, 1 running jobs, and 6 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 23 enabled jobs, 0 disabled jobs, 1 running jobs, and 6 live last-error jobs.
