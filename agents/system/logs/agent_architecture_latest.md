...
- Checked: 2026-05-29T14:07:09.641650+02:00
...
- Live last-error residue: apollo-channel-monitor, blocked-channel-recovery, competitor-analysis, content-poster, marketing-research-daily, ralph-site-owner-loop
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 24 enabled/total-visible jobs, 0 disabled jobs, 2 running jobs, and 6 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 24 enabled jobs, 0 disabled jobs, 2 running jobs, and 6 live last-error jobs.
