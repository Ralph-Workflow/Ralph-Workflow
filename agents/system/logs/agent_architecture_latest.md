...
- Checked: 2026-05-28T07:38:12.927694+02:00
...
- Live running jobs now: marketing-workflow-audit, reddit-pipeline-watchdog
- Live last-error residue: Push research findings to git repo, marketing-momentum-watchdog
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 25 enabled/total-visible jobs, 0 disabled jobs, 2 running jobs, and 2 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 25 enabled jobs, 0 disabled jobs, 2 running jobs, and 2 live last-error jobs.
