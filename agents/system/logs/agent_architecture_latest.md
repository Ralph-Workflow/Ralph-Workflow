...
- Checked: 2026-05-30T22:24:37.345372+02:00
...
- Live running jobs now: agent-architecture-watchdog, codeberg-github-mirror-sync, ralph-docs-supervisor-precheck, reddit-pipeline-watchdog, system-health-monitor
- Live last-error residue: Push research findings to git repo, blocked-channel-recovery, reddit-monitor
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 26 enabled/total-visible jobs, 0 disabled jobs, 5 running jobs, and 3 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 26 enabled jobs, 0 disabled jobs, 5 running jobs, and 3 live last-error jobs.
