...
- Checked: 2026-05-28T08:41:22.789099+02:00
...
- Live running jobs now: marketing-active-loop, ralph-site-owner-loop, system-health-monitor
- Live last-error residue: Push research findings to git repo, marketing-momentum-watchdog, marketing-workflow-audit
...
2. **Medium — Live Gateway topology matches the current runtime state**
   - Mechanism: Direct live cron inspection shows 26 enabled/total-visible jobs, 0 disabled jobs, 3 running jobs, and 3 live last-error jobs.
...
- **refreshed_live_topology** — Refreshed the audit against the current live view: 26 enabled jobs, 0 disabled jobs, 3 running jobs, and 3 live last-error jobs.
