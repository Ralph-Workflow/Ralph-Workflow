...
Chosen lane: **curator_contact_handoff_packet**
...
- Prepared curator targets already have current non-GitHub contact discovery, so the next packet should advance manual maintainer contact instead of another generic PR handoff.
