...
- 3 curator outreach targets are already live in the queue, so the loop should advance or review them instead of regenerating the same packet.
- 3 prepared curator targets still need a canonical execution handoff packet.
