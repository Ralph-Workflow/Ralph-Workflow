...
_LEGACY_BYPASS_COMMENT_ALLOWLIST: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("ralph/agents/catalog.py", 240),
        ("ralph/agents/catalog.py", 281),
        ("ralph/agents/catalog.py", 496),
        ("ralph/agents/catalog.py", 563),
        ("ralph/agents/catalog.py", 566),
        ...
        ("ralph/agents/idle_watchdog/_waiting_branch.py", 94),
        ...
        ("ralph/display/_terminal_bg_query.py", 222),
        ("ralph/display/_terminal_bg_query.py", 238),
        ...
        ("ralph/agents/execution_state/_factory.py", 321),
        ("ralph/agents/execution_state/_factory.py", 384),
        ("ralph/agents/execution_state/_factory.py", 387),
