...
_LEGACY_BYPASS_COMMENT_ALLOWLIST: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("ralph/testing/audit_test_policy.py", 337),
        ("ralph/testing/audit_test_policy.py", 594),
        ("ralph/testing/audit_test_policy.py", 644),
        ...
        ("ralph/telemetry/_sentry.py", 414),
        ("ralph/telemetry/_sentry.py", 563),
        ("ralph/telemetry/_sentry.py", 589),
        ("ralph/telemetry/_sentry.py", 638),
        ("ralph/telemetry/_sentry.py", 813),
