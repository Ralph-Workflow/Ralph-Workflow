...
class IdleWatchdog:
    ...
    def __init__(
        ...
        *,
        ...
        self._subagent_output_captures: OrderedDict[str, SubagentOutputCapture] = OrderedDict()  # bounded-accumulator-ok  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
        ...
        # (OrderedDict.popitem(last=False) eviction in poll_subagent_output)
        self._evicted_worker_tombstones: OrderedDict[str, None] = OrderedDict()  # bounded-accumulator-ok  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
