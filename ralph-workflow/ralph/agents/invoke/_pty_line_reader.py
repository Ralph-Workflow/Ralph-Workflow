...
class PtyLineReader:
    def __init__(
        ...
        self._recent_choice_lines: deque[str] = deque(maxlen=_RECENT_CHOICE_LINES_MAX)  # bounded-accumulator-ok  # noqa: E501  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
        # module constant cap; FIFO eviction
