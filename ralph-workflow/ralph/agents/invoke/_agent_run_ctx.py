...
class _AgentRunCtx:
    ...
    # Live pipeline signals the watchdog consults on every evaluate()
    # call so the StuckClassifier gate can return DUPLICATE_KILL
    # (when the pipeline is already in a wait state) or
