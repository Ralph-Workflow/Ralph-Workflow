...
class BoundedLinesQueue:
    ...
    def __init__(self, maxlen: int) -> None:
        ...
        self._deque: deque[str] = deque(maxlen=maxlen)  # bounded-accumulator-ok  # noqa: E501  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
