...
def handle_ralph_graph(
    ...
    try:
        ...
        result = graph_module.run_query(  # type: ignore[misc,operator]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
            handle.store,
