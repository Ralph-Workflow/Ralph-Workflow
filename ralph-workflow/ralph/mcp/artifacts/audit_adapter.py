...
class RalphAuditSinkAdapter:
    ...
    def __init__(self, cap: int = _DEFAULT_AUDIT_RECORD_CAP) -> None:
        ...
        self._records: collections.deque[RalphAuditRecord] = collections.deque(maxlen=cap)  # bounded-accumulator-ok  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
        self._lock = Lock()
