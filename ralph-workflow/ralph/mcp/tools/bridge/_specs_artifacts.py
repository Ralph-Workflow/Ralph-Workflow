    ...
    return [
        ...
        ToolSpec(
            metadata=_metadata(
                ...
                description="Edit one markdown plan step by stable S-id and return the updated document.",
                input_schema={"type": "object", "properties": {"content": {"type": "string"}, "action": {"enum": ["insert", "replace", "remove", "move"]}, "step_id": {"type": "string"}, "replacement": {"type": "object"}, "index": {"type": "integer"}}, "required": ["content", "action", "step_id"]},
                required_capability=McpCapability.ARTIFACT_SUBMIT.value,
            ),
            module_name="ralph.mcp.tools.md_artifact",
