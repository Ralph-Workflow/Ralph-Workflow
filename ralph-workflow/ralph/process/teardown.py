...
_SESSION_REGISTRY: OrderedDict[int, int] = (
    OrderedDict()
)  # bounded-accumulator-ok: FIFO-evicted at _SESSION_REGISTRY_MAX entries, and each entry is dropped by teardown_subtree as soon as its subtree is reaped.
