...
class ProcessManager:
    ...
    def __init__(
        ...
        self._terminal_records: OrderedDict[int, ProcessRecord] = OrderedDict()  # bounded-accumulator-ok  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
