...
class ProcessManager:
    ...
    def __init__(
        ...
        # (OrderedDict.popitem(last=False) eviction in _record_terminal_state)
        self._terminal_records: OrderedDict[int, ProcessRecord] = OrderedDict()  # bounded-accumulator-ok  # noqa: E501  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
