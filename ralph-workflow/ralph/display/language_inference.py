...
_SUFFIXES: Final[dict[str, str]] = {
    ".d.ts": "typescript", ".spec.ts": "typescript", ".test.ts": "typescript",
    ".test.tsx": "typescript", ".module.css": "css", ".yaml.j2": "yaml",
    ".yml.j2": "yaml", ".tar.gz": "text",
    ".py": "python", ".pyi": "python", ".rs": "rust", ".go": "go",
    ".c": "c", ".h": "c", ".cc": "cpp", ".cp": "cpp", ".cpp": "cpp",
    ...
    ".dart": "dart", ".vue": "vue", ".svelte": "svelte", ".astro": "astro",
    ".scss": "scss", ".sass": "sass", ".less": "less", ".css": "css",
    ".sql": "sql", ".graphql": "graphql", ".gql": "graphql", ".proto": "protobuf",
    ".thrift": "thrift", ".tf": "hcl", ".tfvars": "hcl", ".hcl": "hcl",
    ".nix": "nix", ".gradle": "groovy", ".bzl": "python", ".star": "python",
    ".json": "json", ".toml": "toml", ".yaml": "yaml", ".yml": "yaml",
    ".ini": "ini", ".cfg": "ini", ".conf": "ini", ".properties": "properties",
    ".csv": "text", ".tsv": "text", ".rst": "rst", ".tex": "latex",
    ".j2": "jinja", ".jinja": "jinja", ".hbs": "handlebars", ".mustache": "html",
...
_NAMES: Final[dict[str, str]] = {
    ...
    "justfile": "make", "rakefile": "ruby", "gemfile": "ruby", "brewfile": "ruby",
    "vagrantfile": "ruby", "cmakelists.txt": "cmake", ".gitignore": "text",
    ".gitattributes": "text", ".editorconfig": "ini", ".bashrc": "bash",
    ".zshrc": "bash", "go.mod": "go", "go.sum": "text", "license": "text",
    "codeowners": "text",
}
...
def _sniff(prefix: str) -> str:
    ...
    shebang_lexer = (
        "python" if "python" in lowered_shebang
        else "bash" if any(shell in lowered_shebang for shell in ("bash", "sh", "zsh", "fish"))
        else ""
    )
