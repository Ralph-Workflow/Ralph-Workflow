...
class RingBuffer:
    ...
    def __init__(self, maxsize: int) -> None:
        ...
        self._buf: collections.deque[str] = collections.deque(maxlen=maxsize)  # bounded-accumulator-ok  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
