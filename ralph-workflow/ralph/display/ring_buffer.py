...
class RingBuffer:
    ...
    def __init__(self, maxsize: int) -> None:
        # bounded-accumulator-ok: deque(maxlen=maxsize); maxsize is the
        # ctor cap (audit requires an int literal)
        self._buf: collections.deque[str] = collections.deque(maxlen=maxsize)  # bounded-accumulator-ok  # noqa: E501  # type: ignore[var-annotated]  # reason: autogenerated code has no type support, see docs/agents/type-ignore-policy.md#autogenerated-code
