...
# The 1.0 s per-test ITIMER_REAL budget charges wall clock. Twelve concurrent
# pytest processes match the verified 12-core profile and avoid the process
# oversubscription that can exhaust the immutable 60-second budget. Operators
# may still explicitly override ``PYTEST_WORKERS`` for a measured environment.
#
