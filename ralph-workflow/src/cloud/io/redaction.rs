//! Redaction utilities for cloud-mode I/O boundary.
//!
//! This module provides compiled regex patterns for secret redaction.
//! The patterns are cached using LazyLock for performance.
