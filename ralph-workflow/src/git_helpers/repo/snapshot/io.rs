// git_helpers/repo/snapshot/io.rs — boundary module for git snapshot and status operations.
...
/// Build `StatusOptions` for git snapshot queries (boundary module — mutation allowed here).
