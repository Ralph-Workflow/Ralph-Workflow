...
impl StreamingState {
    ...
    pub fn borrow_session(&self) -> std::cell::Ref<StreamingSession> {
        self.session.borrow()
    }

    pub fn borrow_session_mut(&self) -> std::cell::RefMut<StreamingSession> {
        self.session.borrow_mut()
    }

    pub fn terminal_mode(&self) -> std::cell::Ref<crate::json_parser::terminal::TerminalMode> {
        self.terminal_mode.borrow()
    }

    pub fn terminal_mode_mut(
        &self,
    ) -> std::cell::RefMut<crate::json_parser::terminal::TerminalMode> {
        self.terminal_mode.borrow_mut()
    }

    pub fn thinking_active_index(&self) -> std::cell::Ref<Option<u64>> {
        self.thinking_active_index.borrow()
    }

    pub fn thinking_active_index_mut(&self) -> std::cell::RefMut<Option<u64>> {
        self.thinking_active_index.borrow_mut()
    }

    pub fn thinking_non_tty_indices(&self) -> std::cell::Ref<std::collections::BTreeSet<u64>> {
        self.thinking_non_tty_indices.borrow()
    }

    pub fn thinking_non_tty_indices_mut(
        &self,
    ) -> std::cell::RefMut<std::collections::BTreeSet<u64>> {
        self.thinking_non_tty_indices.borrow_mut()
    }

    pub fn suppress_thinking_for_message(&self) -> std::cell::Ref<bool> {
        self.suppress_thinking_for_message.borrow()
    }

    pub fn suppress_thinking_for_message_mut(&self) -> std::cell::RefMut<bool> {
        self.suppress_thinking_for_message.borrow_mut()
    }

    pub fn text_line_active(&self) -> std::cell::Ref<bool> {
        self.text_line_active.borrow()
    }

    pub fn text_line_active_mut(&self) -> std::cell::RefMut<bool> {
        self.text_line_active.borrow_mut()
    }

    pub fn cursor_up_active(&self) -> std::cell::Ref<bool> {
        self.cursor_up_active.borrow()
    }

    pub fn cursor_up_active_mut(&self) -> std::cell::RefMut<bool> {
        self.cursor_up_active.borrow_mut()
    }

    pub fn last_rendered_content(
        &self,
    ) -> std::cell::Ref<std::collections::HashMap<String, String>> {
        self.last_rendered_content.borrow()
    }

    pub fn last_rendered_content_mut(
        &self,
    ) -> std::cell::RefMut<std::collections::HashMap<String, String>> {
