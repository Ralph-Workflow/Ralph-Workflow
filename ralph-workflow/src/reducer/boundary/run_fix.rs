    ...
    pub(super) fn prepare_fix_prompt(
        ...
        let (
            ...
            PromptMode::XsdRetry => {
                ...
                let current_prompt_content_id = build_fix_xsd_retry_prompt_content_id(
                    &prompt_id,
                    &plan_id,
                    &issues_id,
                    xsd_error,
            ...
            PromptMode::SameAgentRetry => {
                ...
                let plan_id = sha256_hex_str(&plan_content);
                let issues_id = sha256_hex_str(&issues_content);
                let current_prompt_content_id = build_fix_prompt_content_id(
                    &prompt_id,
                    &plan_id,
                    &issues_id,
            ...
            PromptMode::Normal => {
                ...
                let current_prompt_content_id =
                    build_fix_normal_prompt_content_id(&prompt_id, &plan_id, &issues_id);
            ...
            PromptMode::Continuation => {
                ...
                let plan_id = sha256_hex_str(&plan_content);
                let issues_id = sha256_hex_str(&issues_content);
                let current_prompt_content_id = build_fix_continuation_prompt_content_id(
                    continuation_state.fix_continuation_attempt,
                    &status.to_string(),
                    &summary,
                    &prompt_id,
