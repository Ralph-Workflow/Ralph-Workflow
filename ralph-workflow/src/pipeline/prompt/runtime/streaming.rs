//! Runtime streaming I/O for agent output.
//!
//! This module contains the boundary code for streaming agent output.
//! It can use imperative patterns (loops, mutation) since it's at the I/O boundary.
