...
pub type SharedFileActivityTracker = Arc<runtime::FileActivityTrackerInner>;

mod runtime {
    use super::super::file_activity::FileActivityTracker;
    use std::sync::Mutex;

    pub struct FileActivityTrackerInner(Mutex<FileActivityTracker>);
...
pub fn new_file_activity_tracker() -> SharedFileActivityTracker {
    Arc::new(runtime::FileActivityTrackerInner::new())
}
