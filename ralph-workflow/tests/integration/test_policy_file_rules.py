...
_LEGACY_BYPASS_COMMENT_ALLOWLIST: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("ralph/mcp/tools/artifact.py", 379),
        ("ralph/mcp/tools/artifact.py", 689),
        ("ralph/mcp/tools/workspace/_media_io.py", 103),
        ("ralph/mcp/tools/workspace/_media_io.py", 177),
        ("ralph/pipeline/run_loop.py", 944),
        ("ralph/skills/_auto_commit.py", 259),
        ("ralph/skills/_auto_commit.py", 262),
        ("ralph/telemetry/_sentry.py", 362),
        ("ralph/telemetry/_sentry.py", 442),
        ("ralph/telemetry/_sentry.py", 464),
        ("ralph/telemetry/_sentry.py", 513),
        ("ralph/telemetry/_sentry.py", 600),
        ("ralph/testing/audit_lint_bypass.py", 488),
        ("ralph/testing/audit_skill_auto_commit.py", 183),
        ("ralph/testing/audit_skill_auto_commit.py", 282),
        ("ralph/testing/audit_test_policy.py", 286),
        ("ralph/testing/audit_test_policy.py", 568),
        ("ralph/testing/audit_test_policy.py", 635),
