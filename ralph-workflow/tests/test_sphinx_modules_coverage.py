...
_EXCLUDED: dict[str, str] = {
    ...
    "pro_support": "Pro integration docs live in tmp/, not Sphinx",
    "pro_support.env": "Pro integration docs live in tmp/, not Sphinx",
    "pro_support.heartbeat": "Pro integration docs live in tmp/, not Sphinx",
    "pro_support.marker": "Pro integration docs live in tmp/, not Sphinx",
    "pro_support.prompt": "Pro integration docs live in tmp/, not Sphinx",
    "pro_support.workspace": "Pro integration docs live in tmp/, not Sphinx",
