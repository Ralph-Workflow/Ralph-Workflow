...
(``test_phases_commit_logging_commit_attempt_log.py``,
``test_phases_commit_logging_commit_logging_session.py``,
``test_phases_commit_logging_commit_logging_session_formatting.py``,
``test_phases_commit_logging_sanitize_agent_name.py``).
...
# =============================================================================
# CommitLoggingSession formatting
# =============================================================================
