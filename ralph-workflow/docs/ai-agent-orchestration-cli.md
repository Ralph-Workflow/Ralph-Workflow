...
- let different phases route to different agents
- preserve artifacts and checkpoints for long runs
- ship with a strong default workflow before you customize anything

## Where Ralph Workflow fits

Ralph Workflow is built for that exact gap: longer coding work that needs **composable loops**, not just a single smart agent session.
...
- a strong default software-writing workflow out of the box
- room to compose more complex autonomous workflows later
