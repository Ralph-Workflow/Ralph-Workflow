...
- **Caveats**:
    ...
    - Session continuation is unproven: v1.1.8 publishes continuation-related flags, but a resume probe has not been run, so Ralph Workflow does not reuse AGY sessions.
