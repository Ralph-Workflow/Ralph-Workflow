...
| **Google Anti Gravity (AGY)** | Google's Antigravity CLI (`agy`), measured on v1.1.8; re-measure periodically because published IDs and flags can change. Live paid-operation verification is pending. |
